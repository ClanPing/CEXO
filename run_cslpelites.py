#!/usr/bin/env python3
"""
Main CSLP Elite Construction Site Layout Optimizer
==================================================

Main execution script for the CSLP Elite algorithm (MAP-Elites + NSGA-II).
...
from core.cslpelites_algorithm import (
    MapElitesNSGA2Optimizer,
    evaluate_mapelites_performance,
)
from core.visualization import (
    create_mapelites_visualizations,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="CSLP Elite Construction Site Layout Optimizer",
    ...
    if stats['safety_feasible_count'] > 0:
        ...
        with open(os.path.join(args.output_dir, "cslpelite_evaluation.json"), 'w') as f:
